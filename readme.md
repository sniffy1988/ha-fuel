...
* **Динамічний вибір через UI**: під час налаштування ви обираєте заправки та види палива (`А-95+`, `А-95`, `А-92`, `ДП`, `Газ`).
* **Регіон — Харківська обл.**: дані беруться з регіональної таблиці Мінфіну; оператори підтягуються з актуальної таблиці, а при недоступності сайту — із запасного списку.
* **Зміна налаштувань**: операторів і паливо можна змінити пізніше в опціях інтеграції.
* **Автоматичне оновлення**: фонове опитування джерела кожні 4 години.
