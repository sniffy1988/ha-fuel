...
* **SOCAR з офіційного сайту**: для SOCAR ціни беруться з [socar.ua/fuel](https://socar.ua/fuel) — усі продукти: **NANO 100**, **ДП+**, **NANO ДП**, **NANO 95**, **А-95**, **LPG**, **AdBlue**; інші АЗС — з [Мінфіну](https://index.minfin.com.ua/ua/markets/fuel/reg/harkovskaya/) (Харківська обл.).
